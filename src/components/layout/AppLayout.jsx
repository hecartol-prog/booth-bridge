...
import {
  ...
  Bell, Menu, X, Briefcase, Camera, CreditCard, LogOut, User } from
"lucide-react";
      ...
      <aside className="hidden md:flex flex-col w-64 shrink-0 bg-sidebar text-sidebar-foreground border-r border-sidebar-border h-full">
        <div className="p-5">
          <Link to="/" className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-sidebar-foreground tracking-widest uppercase text-base" style={{ fontFamily: "'Orbitron', sans-serif", letterSpacing: "0.15em" }}>Booth Bridge</span>
          </Link>
        </div>
